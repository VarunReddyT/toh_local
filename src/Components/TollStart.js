...
export default function TollStart(props) {
    ...
    return (
            ...
            <div className="container">
                <div className="mt-5 d-flex container flex-column justify-content-center align-items-center shadow-lg border border-black p-4"style={{borderRadius:'10px' , maxWidth:'600px'  }}>
                ...
                <div className="row mt-4 d-flex justify-content-center">
                    ...
                    <div className="col-sm-5 m-1 d-flex justify-content-center">
                        <button type="button"  className="btn btn-dark  d-flex w-75 justify-content-center">
                        HOW TO
                    </button></div>
                    <div className="col-sm-6 m-1 d-flex justify-content-center">
                    <button type="button"  className="btn btn-dark d-flex w-75 justify-content-center">
