...
export default function CheckRecords() {
  ...
  return (
    <div className='parenth'>
      ...
      <h1 className='mt-5 border border-black border-3 rounded-5 p-4' style={{backdropFilter:'blur(2px)'}} >Toll Check Records : {'Hyderabad'}</h1>
        <form onSubmit={checkDate} style={{backdropFilter:'blur(2px)'}} className='container mb-4 rounded-3 p-2   justify-content-center' >
          <div className='d-flex justify-content-center align-items-center' style={{backgroundColor:'lightblue',width:'30%'}}>
        <LocalizationProvider dateAdapter={AdapterDayjs}>
